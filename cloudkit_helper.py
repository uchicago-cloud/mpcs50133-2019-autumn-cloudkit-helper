...
KEY_ID = '99e04a281f141f4bce822833bd8e87827b91489f1f0601a721eb0c3adf788681'
CONTAINER = 'iCloud.mobi.uchicago.twenty-nineteen-cloudkit'
...
def curl(url, params=None, auth=None, req_type='GET', data=None, headers=None):
    ...
    if auth is not None:
        ...
        handler_chain.append(urllib.request.HTTPBasicAuthHandler(manager))
    ...
    director = urllib.request.build_opener(*handler_chain)
    ...
    if req_type in post_req:
        ...
        req = urllib.request.Request(url, headers=_headers, data=_data)
